...
// Return the ordinal suffix for a number (e.g. "1st", "2nd", "3rd")
...
// Draw spring F vs x chart (Hooke’s Law) using Chart.js
...
// Draw a sine wave trace like an oscilloscope using Chart.js
      ...
      scales: {
        x: {
          ...
          grid: {
            ...
            color: ctx => Number.isInteger(ctx.tick.value / timeBase)
              ? 'rgba(0,0,0,0.3)'
              : 'rgba(200,0,0,0.1)',
