...
// 5) Build question pool based on checks & difficulty
...
// 7) Wire up buttons and initialize on page load
window.addEventListener("DOMContentLoaded", () => {
  const questionBox = document.getElementById("question-box");

  // Insert control buttons after the question box
  [
